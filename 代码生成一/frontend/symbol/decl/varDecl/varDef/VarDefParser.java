...
import frontend.symbol.decl.varDecl.varDef.varInitVal.VarInitValParser;
...
public class VarDefParser {
    ...
    public VarDef parseVarDef() {
        ...
        if (tokens.get(0).getCode().equals(TokenCode.ASSIGN)) {
           ...
           varDefFactor = new VarDefWithAssign(ident, lBrack, constExp, rBrack, assign, varInitVal, symbolTable);
        } else {
            varDefFactor = new VarDefWithNull(ident, lBrack, constExp, rBrack, symbolTable);
        }
