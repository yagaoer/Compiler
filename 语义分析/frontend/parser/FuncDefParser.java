...
public class FuncDefParser {
    ...
    public FuncDef parseFuncDef() {
        ...
        addFuncSymbol(ident, funcType.getFuncTypeFactor(), symbols);
        ...
        if (tokens.get(0).getCode().equals(TokenCode.INTTK) ||
            ...
            funcFParams = new FuncFParamsParser(tokens, symbolTable, symbols).parseFuncFParams();
        }
    ...
    private void addFuncSymbol(Ident ident, FuncTypeFactor funcTypeFactor, ArrayList<Symbol> symbols) {
